...
<CardContainer>
  ...
  <ToolCard
    link="https://english-grammar.app/"
    icon="/icons/英文3.svg"
    title="English"
    description="Learn English Grammar Lessons, Practice, Progress"
  />
...
<h2>塔罗相关</h2>
<p>关于各种塔罗牌的相关网站和简单笔记</p>

<CardContainer>
  <ToolCard
    link="https://tarotqa.com/zh-CN/gallery"
    icon="/icons/favicon_small.png"
    title="TarotQA"
    description="了解每张牌的象征意义和解读方式"
  />

  <ToolCard
    link="https://tarotara.com/zh"
    icon="/icons/tarotara.png"
    title="tarotara"
    description="线上塔罗占卜+牌阵解说"
  />

  <ToolCard
    link="https://tarothall.com/"
    icon="/icons/taluo.png"
    title="塔罗馆"
    description="免费塔罗占卜"
  />
</CardContainer>
